                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'xe71cegy' /* Let's get started by filling o... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                          ...
                                          children: [
                                            TextSpan(
                                              text: FFLocalizations.of(context)
                                                  .getText(
                                                'tg0dl21y' /* Already have an account?  */,
                                              ),
                                              style: TextStyle(),
                                            ),
                                            TextSpan(
                                        ...
                                        children: [
                                          Expanded(
                                            child: AutoSizeText(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'gv0mdsac' /* Nice outdoor courts, solid con... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
