                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'tw24gd8q' /* Get started by creating an acc... */,
                                ),
                                      ...
                                      children: [
                                        TextSpan(
                                          text: FFLocalizations.of(context)
                                              .getText(
                                            '2mjukngq' /* Already have an account?  */,
                                          ),
                                          style: TextStyle(),
                                        ),
                                        TextSpan(
