                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        wrapWithModel(
                          model: _model.mixedfeelingsheaderModel,
                          updateCallback: () => safeSetState(() {}),
                          child: MixedfeelingsheaderWidget(),
                        ),
                      ],
                    ),
                  ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'kb3j3jww' /* Fill out the information below... */,
                                ),
                                      ...
                                      children: [
                                        TextSpan(
                                          text: FFLocalizations.of(context)
                                              .getText(
                                            'ta8vp1j1' /* Don't have an account?   */,
                                          ),
                                          style: TextStyle(),
                                        ),
                                        TextSpan(
